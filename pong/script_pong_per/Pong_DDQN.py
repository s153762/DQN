...
name = f'PER_{init_time}'
writer = SummaryWriter(f'../runs/report_runs/{name}_{env_name}')
...
for i_episode in range(num_episodes):
    ...
    for t in count():
        ...
        if steps_done % TARGET_UPDATE == 0 or steps_done == 1:
            ...
            total_reward_test, actions_test = test(envTest, steps_done, resize, 5, policy_net, device, actions_offset,
                                                   Skip, False)
